  ...
  const handleSend = async () => {
    ...
    try {
      ...
      setMessages(prev => [...prev, { 
        role: 'assistant', 
        text: lang === 'en'
          ? 'Sorry, I am having connection issues. Please contact us via WhatsApp at +506 8404-6973 / +506 6060-4775 / +1 (831) 471-5559.'
          : 'Lo siento, estoy teniendo problemas de conexión. Por favor, contáctanos por WhatsApp al +506 8404-6973 / +506 6060-4775 / +1 (831) 471-5559.'
      }]);
    } finally {
      setIsLoading(false);
    }
