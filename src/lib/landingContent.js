...
export const DEFAULT_LANDING_PAGE_SETTINGS = {
  ...
  heroSubEn: 'Explore our catalog, review product information, and check availability and delivery options within Costa Rica.',
  heroSubEs: 'Explora nuestro catálogo, revisa la información de productos y verifica opciones de entrega dentro de Costa Rica.',
  heroTextEn: 'Information about our catalog, product specifications, availability, and delivery within Costa Rica.',
  heroTextEs: 'Información sobre nuestro catálogo, especificaciones de productos, disponibilidad y entrega dentro de Costa Rica.',
  ...
  footerCategoryLinks: [
    ...
    { labelEn: 'Retatrutide', labelEs: 'Retatrutide', href: '/catalog?category=Retatrutide' },
