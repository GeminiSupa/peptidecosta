...
export const DEFAULT_PUBLIC_PAGE_SETTINGS = {
  ...
  page_about: {
    pageVersion: 'v1',
    heroKickerEn: 'JOEY, SEAN, AND A LOCAL IDEA',
    heroKickerEs: 'JOEY, SEAN Y UNA IDEA LOCAL',
    heroTitleEn: 'This started in fight gyms, not a boardroom.',
    heroTitleEs: 'Esto comenzó en gimnasios de combate, no en una sala de juntas.',
    heroTextEn: 'Joey Webster and Sean McCully have spent more than 15 years living, training, and building community in Costa Rica. Peptides Costa Rica grew out of a problem they kept running into themselves: getting reliable research products locally was unnecessarily difficult.',
    heroTextEs: 'Joey Webster y Sean McCully llevan más de 15 años viviendo, entrenando y formando comunidad en Costa Rica. Peptides Costa Rica nació de un problema que ellos mismos encontraban una y otra vez: conseguir productos de investigación confiables localmente era innecesariamente difícil.',
    principles: [
      { labelEn: 'Stock already in Costa Rica', labelEs: 'Inventario ya en Costa Rica' },
      { labelEn: 'COA documentation available', labelEs: 'Documentación COA disponible' },
      { labelEn: 'Direct support from real people', labelEs: 'Atención directa de personas reales' },
      { labelEn: 'Clear pricing before you order', labelEs: 'Precios claros antes de ordenar' },
    ],
    proofKickerEn: 'LOCAL MODEL',
    proofKickerEs: 'MODELO LOCAL',
    proofTitleEn: 'Built for the local reality',
    proofTitleEs: 'Creado para la realidad local',
    proofTextEn: 'This is not an anonymous overseas storefront. It is a Costa Rica business built around availability, documentation, and direct communication.',
    proofTextEs: 'Esto no es una tienda anónima del exterior. Es un negocio en Costa Rica basado en disponibilidad, documentación y comunicación directa.',
    originTitleEn: 'Two longtime training partners',
    originTitleEs: 'Dos compañeros de entrenamiento de muchos años',
    originTextEn: 'Sean is a world champion in Muay Thai and kickboxing, an early MMA pioneer, and the founder of LA Boxing. He now runs McCully’s Fight Club in Costa Rica. Joey is a former wrestling champion who continued training in boxing, Muay Thai, and MMA after moving from California to Costa Rica.',
    originTextEs: 'Sean es campeón mundial de Muay Thai y kickboxing, pionero del MMA y fundador de LA Boxing. Hoy dirige McCully’s Fight Club en Costa Rica. Joey fue campeón de lucha y continuó entrenando boxeo, Muay Thai y MMA después de mudarse de California a Costa Rica.',
    founders: [
      { initials: 'JW', name: 'Joey Webster', roleEn: 'Wrestling champion & fighter', roleEs: 'Campeón de lucha y peleador' },
      { initials: 'SM', name: 'Sean McCully', roleEn: 'Combat sports pioneer & coach', roleEs: 'Pionero y entrenador de deportes de combate' },
    ],
    quoteEn: 'We wanted to know what was actually available, see the documentation, and talk to someone nearby. So we built the local option we had been looking for.',
    quoteEs: 'Queríamos saber qué había realmente disponible, ver la documentación y hablar con alguien cercano. Así que creamos la opción local que nosotros mismos buscábamos.',
    quoteAuthor: '— Joey & Sean',
    problemTitleEn: 'The problem was practical',
    problemTitleEs: 'El problema era práctico',
    problemTextEn: 'International orders meant long waits, customs uncertainty, unclear stock, and very little communication when something went wrong. The answer was not another complicated storefront. It was inventory already in Costa Rica, clear batch information, and direct conversation.',
    problemTextEs: 'Los pedidos internacionales implicaban largas esperas, incertidumbre en aduanas, inventario poco claro y casi ninguna comunicación cuando algo salía mal. La respuesta no era otra tienda complicada. Era tener inventario en Costa Rica, información clara de cada lote y conversación directa.',
    todayTitleEn: 'What we do today',
    todayTitleEs: 'Lo que hacemos hoy',
    todayTextEn: 'We serve customers within Costa Rica. We publish current products and prices, make available batch documentation, coordinate local delivery, and answer questions directly in Spanish or English. We would rather give a clear answer than make an oversized promise.',
    todayTextEs: 'Atendemos clientes dentro de Costa Rica. Publicamos productos y precios actuales, facilitamos la documentación de los lotes, coordinamos la entrega local y respondemos directamente en español o inglés. Preferimos dar una respuesta clara antes que hacer una promesa exagerada.',
    processTitleEn: 'How the local model works',
    processTitleEs: 'Cómo funciona el modelo local',
    process: [
      { titleEn: 'Visible stock', titleEs: 'Inventario visible', textEn: 'See what is currently available before you spend time asking.', textEs: 'Revisa qué está disponible antes de perder tiempo preguntando.' },
      { titleEn: 'Batch clarity', titleEs: 'Claridad de lote', textEn: 'Review COA and product details from the catalog flow.', textEs: 'Consulta COA y detalles del producto desde el flujo del catálogo.' },
      { titleEn: 'Direct coordination', titleEs: 'Coordinación directa', textEn: 'Ask questions and coordinate delivery with a real person.', textEs: 'Haz preguntas y coordina la entrega con una persona real.' },
    ],
    ...
    contactButtonEn: 'Ask on WhatsApp',
    contactButtonEs: 'Preguntar por WhatsApp',
  },
  page_faq: {
    pageVersion: 'v1',
    ...
    faqItems: [
      ...
      },
      {
        ...
        qEs: '¿Puedo pedir por WhatsApp?',
        aEn: 'Absolutely. Message us on WhatsApp ({{whatsapp}}) and we will walk you through your order.',
        aEs: 'Por supuesto. Escríbenos al WhatsApp ({{whatsapp}}) y te guiamos con tu pedido.',
      },
    ],
  ...
  page_contact: {
    ...
    whatsappButtonEn: 'Chat on WhatsApp',
    whatsappButtonEs: 'Chatear por WhatsApp',
