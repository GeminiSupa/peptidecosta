      ...
      <div style="padding:32px;">
        ...
        <div style="background:#f0fdf4;border:1px dashed #059669;border-radius:16px;padding:24px;text-align:center;max-width:500px;margin:0 auto;">
          ...
          <p style="margin:0 0 20px;color:#0f172a;font-size:14.5px;line-height:1.6;font-weight:600;">
            <strong>Costa Rica:</strong> +506 8404-6973 / +506 6060-4775<br/>
    ...
    if (!skipCustomer && order.customerEmail && order.customerEmail.trim() !== '') {
      try {
        ...
        const customerText = [
          ...
          '',
          orderLang === 'en' 
            ? `Need help? Contact our support desk at +506 8404-6973 (CR) / +506 6060-4775 (CR) / +1 (831) 471-5559 (US) or reply to this email.`
            : `Necesita ayuda? Contacte a soporte al +506 8404-6973 (CR) / +506 6060-4775 (CR) / +1 (831) 471-5559 (US) o responda a este correo.`
        ].join('\n');
